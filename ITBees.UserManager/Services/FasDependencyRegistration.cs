...
namespace ITBees.UserManager.Services
{
    public class FasDependencyRegistration
    {
            ...
            bool enableLoginWithoutPasswordChecking = false) where TContext : DbContext where TIdentityUser : IdentityUser<Guid>, new() where TCompany : Company, new()
        {
            ...
            services.AddScoped<IConfirmationUrlParametersStore, ConfirmationUrlParametersStore>();
            services.AddScoped(typeof(IPlatformSubscriptionService), typeof(PlatformSubscriptionService));
            ...
            services.AddScoped(typeof(ICompanyBootstrapService), typeof(CompanyBootstrapService<TCompany>));
